...
bool DNA::save(const QString& filename, unsigned long generation, unsigned long selected, quint64 fitness, quint64 duration)
{
    bool rc;
    QFile file(filename);
    ...
    if (filename.endsWith(".json") || filename.endsWith(".dna")) {
        out << "{\n"
            ...
            << " \"totalseconds\": \"" << (mTotalSeconds + duration) << "\",\n"
        ...
        out << "<svg xmlns=\"http://www.w3.org/2000/svg\" version=\"1.1\" width=\"" << mSize.width() << "\" height=\"" << mSize.height() << "\">\n"
            ...
            << " <evocubist:totalseconds>" << (mTotalSeconds + duration) << "</evocubist:totalseconds>\n"
